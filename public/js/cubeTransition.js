(function ($) {
    ...
    function show() {
        ...
        $('#cubeTransition>div:eq(' + (next - 1) + ')').find('li div').each(function () {
        ...
        if (current == 1) {
            $('.sub-title-2').fadeOut().html('Info Kelembapan').fadeIn();
        } else if (current == 2) {
            $('.sub-title-2').fadeOut().html('Info Kecepatan dan Arah Angin').fadeIn();
        } else{
            $('.sub-title-2').fadeOut().html('Info Cuaca').fadeIn();
        }
        ...
        setTimeout(function () {
            ...
            $('#cubeTransition>div:eq(' + (current - 1) + ')').find('li div').each(function () {
